...
//                        DOUBLE MOVE
                        ...
                        if (doubleMove.inBounds()){
                            ...
                            if (doublePiece == null && myPosition.getRow() == 2 && this.teamColor == ChessGame.TeamColor.WHITE) {
                                possibleMoves.add(new ChessMove(myPosition, doubleMove, null));
                            }
                            else if(doublePiece == null && myPosition.getRow() == 7 && this.teamColor == ChessGame.TeamColor.BLACK){
                                possibleMoves.add(new ChessMove(myPosition, doubleMove, null));
                            }}
                    }
